...
ID=$(xinput | grep "HID 256c:006d stylus" | grep pointer | awk '{print substr($6, 4, 5)}')
...
xsetwacom --set 'HID 256c:006d stylus' Button 3 "key +ctrl +shift p -shift -ctrl"
# xsetwacom --set 'HID 256c:006d stylus' Button 2 2
